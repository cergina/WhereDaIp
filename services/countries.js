...
function getLocationByCode(code) {
  ...
  return countryGeolocList[0]
}

function getCountryArrayCountsZero() {
  var arr = []

  for (var x of countryList) {
    arr.push({"name": x.name, "count": 0})
  }

  return arr
}
function getGeolocCodeArrayCountsZero() {
  var arr = []
...
module.exports = {
  getCountryNameByCode, getCountryArrayCountsZero, getLocationByCode, getGeolocCodeArrayCountsZero
}
...
const countryList = [
  ...
  const countryGeolocList = [
    {code: "N/A", latitude:	0.0, longitude:	0.0, name:	"Unknown"},
    ...
    {code: "AN", latitude:	12.226079, longitude:	-69.060087, name:	"Netherlands Antilles"},
    {code: "AO", latitude:	-11.202692, longitude:	17.873887, name:	"Angola"},
    {code: "AQ", latitude:	-75.250973, longitude:	-0.071389, name:	"Antarctica"},
    {code: "AR", latitude:	-38.416097, longitude:	-63.616672, name:	"Argentina"},
    {code: "AS", latitude:	-14.270972, longitude:	-170.132217, name:	"American Samoa"},
    ...
    {code: "BV", latitude:	-54.423199, longitude:	3.413194, name:	"Bouvet Island"},
    ...
    {code: "CC", latitude:	-12.164165, longitude:	96.870956, name:	"Cocos [Keeling] Islands"},
    {code: "CD", latitude:	-4.038333, longitude:	21.758664, name:	"Congo [DRC]"},
    {code: "CF", latitude:	6.611111, longitude:	20.939444, name:	"Central African Republic"},
    {code: "CG", latitude:	-0.228021, longitude:	15.827659, name:	"Congo [Republic]"},
    ...
    {code: "CK", latitude:	-21.236736, longitude:	-159.777671, name:	"Cook Islands"},
    ...
    {code: "CX", latitude:	-10.447525, longitude:	105.690449, name:	"Christmas Island"},
    ...
    {code: "EH", latitude:	24.215527, longitude:	-12.885834, name:	"Western Sahara"},
    ...
    {code: "FK", latitude:	-51.796253, longitude:	-59.523613, name:	"Falkland Islands [Islas Malvinas]"},
    {code: "FM", latitude:	7.425554, longitude:	150.550812, name:	"Micronesia"},
    {code: "FO", latitude:	61.892635, longitude:	-6.911806, name:	"Faroe Islands"},
    ...
    {code: "GF", latitude:	3.933889, longitude:	-53.125782, name:	"French Guiana"},
    ...
    {code: "GP", latitude:	16.995971, longitude:	-62.067641, name:	"Guadeloupe"},
    ...
    {code: "GS", latitude:	-54.429579, longitude:	-36.587909, name:	"South Georgia and the South Sandwich Islands"},
    ...
    {code: "HM", latitude:	-53.08181, longitude:	73.504158, name:	"Heard Island and McDonald Islands"},
    ...
    {code: "IM", latitude:	54.236107, longitude:	-4.548056, name:	"Isle of Man"},
    {code: "IN", latitude:	20.593684, longitude:	78.96288, name:	"India"},
    {code: "IO", latitude:	-6.343194, longitude:	71.876519, name:	"British Indian Ocean Territory"},
    ...
    {code: "MK", latitude:	41.608635, longitude:	21.745275, name:	"Macedonia [FYROM]"},
    {code: "ML", latitude:	17.570692, longitude:	-3.996166, name:	"Mali"},
    {code: "MM", latitude:	21.913965, longitude:	95.956223, name:	"Myanmar [Burma]"},
    {code: "MN", latitude:	46.862496, longitude:	103.846656, name:	"Mongolia"},
    {code: "MO", latitude:	22.198745, longitude:	113.543873, name:	"Macau"},
    {code: "MP", latitude:	17.33083, longitude:	145.38469, name:	"Northern Mariana Islands"},
    {code: "MQ", latitude:	14.641528, longitude:	-61.024174, name:	"Martinique"},
    ...
    {code: "NC", latitude:	-20.904305, longitude:	165.618042, name:	"New Caledonia"},
    {code: "NE", latitude:	17.607789, longitude:	8.081666, name:	"Niger"},
    {code: "NF", latitude:	-29.040835, longitude:	167.954712, name:	"Norfolk Island"},
    ...
    {code: "PF", latitude:	-17.679742, longitude:	-149.406843, name:	"French Polynesia"},
    ...
    {code: "PM", latitude:	46.941936, longitude:	-56.27111, name:	"Saint Pierre and Miquelon"},
    {code: "PN", latitude:	-24.703615, longitude:	-127.439308, name:	"Pitcairn Islands"},
    {code: "PR", latitude:	18.220833, longitude:	-66.590149, name:	"Puerto Rico"},
    {code: "PS", latitude:	31.952162, longitude:	35.233154, name:	"Palestinian Territories"},
    ...
    {code: "SH", latitude:	-24.143474, longitude:	-10.030696, name:	"Saint Helena"},
    {code: "SI", latitude:	46.151241, longitude:	14.995463, name:	"Slovenia"},
    {code: "SJ", latitude:	77.553604, longitude:	23.670272, name:	"Svalbard and Jan Mayen"},
    ...
    {code: "TC", latitude:	21.694025, longitude:	-71.797928, name:	"Turks and Caicos Islands"},
    {code: "TD", latitude:	15.454166, longitude:	18.732207, name:	"Chad"},
    {code: "TF", latitude:	-49.280366, longitude:	69.348557, name:	"French Southern Territories"},
    ...
    {code: "VI", latitude:	18.335765, longitude:	-64.896335, name:	"U.S. Virgin Islands"},
    {code: "VN", latitude:	14.058324, longitude:	108.277199, name:	"Vietnam"},
    {code: "VU", latitude:	-15.376706, longitude:	166.959158, name:	"Vanuatu"},
    {code: "WF", latitude:	-13.768752, longitude:	-177.156097, name:	"Wallis and Futuna"},
